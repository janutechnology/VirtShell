...
\frame{ \frametitle{Técnicas de Virtualización}
\begin{figure}
	\centering
	\begin{subfigure}[t]{0.4\textwidth}
	\includegraphics[width=0.7\textwidth]{../../architecture/v1/diagrams/contenedores.jpg}
	\caption*{Contenedores}
	\end{subfigure}
  \hspace{0.6cm}
  \pause
  \begin{subfigure}[t]{0.4\textwidth}
    \includegraphics[width=0.7\textwidth]{../../architecture/v1/diagrams/virtualmachine.jpg}
