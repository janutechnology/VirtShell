...
\label{Arquitectura}
VirtShell Framework es concebido como una plataforma que proporciona herramientas para la automatización y gestión de infraestructura, facilitando tareas como la creación, despliegue, mantenimiento y monitoreo tanto de recursos virtuales como físicos vía web. Así mismo, es pensada para permitir que cualquier desarrollo de software con acceso a Internet (sitio web, aplicación móvil, etc.) pueda utilizarlo e interactuar con la infraestructura tan solo haciendo llamadas a direcciones de Internet.\\
\\
Las motivaciones mencionadas conducen a los requisitos para una arquitectura destinada a separar claramente responsabilidades, usando protocolos abiertos, modificables, escalables, y al mismo tiempo adecuado para la creación rápida de acciones. VirtShell se articula alrededor de unos pocos conceptos y principios esenciales, los cuales se mencionan a continuación:

\section{Estilo arquitectural REST}
