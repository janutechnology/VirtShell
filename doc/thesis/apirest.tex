...
\item [ISOS resource] Representa una imagen ISO que permite crear una m'aquina virtual. 
...
\item [Container Template resource] Representa un modelo para crear contenedores personalizados. 
