...
\\
VirtShell usa las tareas principalmente en las operaciones que involucren las instancias, las cuales son denominadas de larga duración, al igual que el envio de múltiples archivos o instalar paquetes en las instancias.
