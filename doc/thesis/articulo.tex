...
\begin{center}
 ...
 \hline
  \textbf{Método} & \textbf{Solicitud} & \textbf{Descripción} \\ [0.5ex] 
  \hline\hline
  POST & /install\_packages/ & Install one or more packages. \\
  \hline
  POST & /upgrade\_packages/ & Upgrade one or more packages. \\
  \hline
  POST & /remove\_packages/ & Remove one or more packages. \\ [1ex] 
  \hline
\end{tabular}
\end{center}
...
\captionof{table}{Métodos HTTP para API Calls}
 ...
 \hline
  \textbf{Método} & \textbf{Solicitud} & \textbf{Descripción} \\ [0.5ex] 
  \hline\hline
  POST & instances/start\_instance/:id & Start one instance. \\
  \hline
  POST & instances/stop\_instance/:id & Stop one instance. \\
  \hline
  POST & instances/restart\_instance/:id & Restart one instance. \\
  \hline
  POST & instances/clone\_instance/:id & Clone one instance. \\
  \hline
  POST & instances/execute\_command & Execute commands. \\
  \hline
