...
\title{IEEE 11CCC 2016\\VirtShell\\Framework para aprovisionamiento de soluciones virtuales}
...
\begin{center}
 ...
 \hline
  \rowfont{\scriptsize} \textbf{Método} & \rowfont{\scriptsize} \textbf{Solicitud} & \rowfont{\scriptsize} \textbf{Descripción} \\ [0.5ex] 
  \hline\hline
  \rowfont{\scriptsize} GET & \rowfont{\scriptsize} /users/:name & \rowfont{\scriptsize} Gets one user by ID. \\
  \hline
  \rowfont{\scriptsize} POST & \rowfont{\scriptsize} /users/ & \rowfont{\scriptsize} creates a new user. \\
  \hline
  \rowfont{\scriptsize} GET & \rowfont{\scriptsize} /users & \rowfont{\scriptsize} Gets the list of users. \\  
  \hline
  \rowfont{\scriptsize} DELETE & \rowfont{\scriptsize} /users/:name & \rowfont{\scriptsize} Deletes an existing user. \\
  \hline  
  \rowfont{\scriptsize} PUT & \rowfont{\scriptsize} /users/:name & \rowfont{\scriptsize} Updates an existing user. \\ [1ex]  
  \hline
\end{tabular}
\end{center}
...
\begin{center}
 ...
 \hline
  \rowfont{\scriptsize} \textbf{Método} & \rowfont{\scriptsize} \textbf{Solicitud} & \rowfont{\scriptsize} \textbf{Descripción} \\ [0.5ex] 
  \hline\hline
  \rowfont{\scriptsize} GET & \rowfont{\scriptsize} /partitions/:name & \rowfont{\scriptsize} Gets one partition. \\
  \hline
  \rowfont{\scriptsize} GET & \rowfont{\scriptsize} /partitions & \rowfont{\scriptsize} Gets the list of partitions. \\
  \hline  
  \rowfont{\scriptsize} POST & \rowfont{\scriptsize} /partitions/ & \rowfont{\scriptsize} Inserts a new partition. \\
  \hline
  \rowfont{\scriptsize} DELETE & \rowfont{\scriptsize} /partitions/:name & \rowfont{\scriptsize} Deletes apartition. \\
  \hline  
  \rowfont{\scriptsize} PUT & \rowfont{\scriptsize} \pbox{5cm}{/partitions/:name/ \\host/:hostname} & \rowfont{\scriptsize} Add a host to partition. \\ [1ex] 
  \hline
\end{tabular}
\end{center}
...
\begin{center}
 ...
 \rowfont{\scriptsize} \textbf{Método} & \rowfont{\scriptsize} \textbf{Solicitud} & \rowfont{\scriptsize} \textbf{Descripción} \\ [0.5ex] 
  \hline\hline
  \rowfont{\scriptsize} GET & \rowfont{\scriptsize} /hosts/:name & \rowfont{\scriptsize} Gets one host by name. \\
  \hline
  \rowfont{\scriptsize} GET & \rowfont{\scriptsize} /hosts & \rowfont{\scriptsize} Gets the list of hosts. \\
  \hline  
  \rowfont{\scriptsize} POST & \rowfont{\scriptsize} /hosts/ & \rowfont{\scriptsize} Inserts a new host. \\
  \hline
  \rowfont{\scriptsize} DELETE & \rowfont{\scriptsize} /hosts/:name & \rowfont{\scriptsize} Deletes an existing host. \\
  \hline  
  \rowfont{\scriptsize} PUT & \rowfont{\scriptsize} /hosts/:name & \rowfont{\scriptsize} Updates an existing host. \\ [1ex] 
  \hline
\end{tabular}
\end{center}
...
\begin{center}
 ...
 \hline
  \rowfont{\scriptsize} \textbf{Método} & \rowfont{\scriptsize} \textbf{Solicitud} & \rowfont{\scriptsize} \textbf{Descripción} \\ [0.5ex] 
  \hline\hline
  \rowfont{\scriptsize} GET & \rowfont{\scriptsize} /provisioners/:name & \rowfont{\scriptsize} Gets one provisioner by ID. \\
  \hline
  \rowfont{\scriptsize} GET & \rowfont{\scriptsize} /provisioners & \rowfont{\scriptsize} Gets the list of provisioners. \\
  \hline  
  \rowfont{\scriptsize} POST & \rowfont{\scriptsize} /provisioners/ & \rowfont{\scriptsize} Creates a new provisioner. \\
  \hline
  \rowfont{\scriptsize} DELETE & \rowfont{\scriptsize} /provisioners/:name & \rowfont{\scriptsize} Deletes an existing host. \\ [1ex] 
  \hline
\end{tabular}
\end{center}
...
\begin{center}
 ...
 \hline
  \rowfont{\scriptsize} \textbf{Método} & \rowfont{\scriptsize} \textbf{Solicitud} & \rowfont{\scriptsize} \textbf{Descripción} \\ [0.5ex] 
  \hline\hline
  \rowfont{\scriptsize} GET & \rowfont{\scriptsize} /tasks/:id & \rowfont{\scriptsize} Gets one task by ID. \\
  \hline
  \rowfont{\scriptsize} GET & \rowfont{\scriptsize} /tasks & \rowfont{\scriptsize} Gets the list of tasks. \\
  \hline
  \rowfont{\scriptsize} GET & \rowfont{\scriptsize} /tasks/status & \rowfont{\scriptsize} Gets all task by status. \\
  \hline 
  \rowfont{\scriptsize} POST & \rowfont{\scriptsize} /tasks/ & \rowfont{\scriptsize} Creates a new task \\
  \hline  
  \rowfont{\scriptsize} PUT & \rowfont{\scriptsize} /tasks/:id & \rowfont{\scriptsize} Updates an existing task. \\ [1ex] 
  \hline
\end{tabular}
\end{center}
...
\begin{center}
 ...
 \hline
  \rowfont{\scriptsize} \textbf{Método} & \rowfont{\scriptsize} \textbf{Solicitud} & \rowfont{\scriptsize} \textbf{Descripción} \\ [0.5ex] 
  \hline\hline
  \rowfont{\scriptsize} GET & \rowfont{\scriptsize} /properties/ & \rowfont{\scriptsize} Install one or more packages. \\ [1ex] 
  \hline
\end{tabular}
\end{center}
...
\begin{center}
 ...
 \hline
  ...
  \rowfont{\scriptsize} POST & \rowfont{\scriptsize} /provisioners/ & \rowfont{\scriptsize} Creates a new provisioner. \\
  \hline
  \rowfont{\scriptsize} DELETE & \rowfont{\scriptsize} /provisioners/:name & \rowfont{\scriptsize} Deletes an provisioner. \\
  \hline  
  \rowfont{\scriptsize} PUT & \rowfont{\scriptsize} /provisioners/:name & \rowfont{\scriptsize} Updates a provisioner. \\ [1ex] 
  \hline
\end{tabular}
\end{center}
...
\begin{center}
 ...
 \hline
  \rowfont{\scriptsize} \textbf{Método} & \rowfont{\scriptsize} \textbf{Solicitud} & \rowfont{\scriptsize} \textbf{Descripción} \\ [0.5ex] 
  \hline\hline
  \rowfont{\scriptsize} GET & \rowfont{\scriptsize} /images/:name & \rowfont{\scriptsize} Gets one image by name. \\
  \hline
  \rowfont{\scriptsize} GET & \rowfont{\scriptsize} /images & \rowfont{\scriptsize} Retrieves the list of images. \\
  \hline  
  \rowfont{\scriptsize} POST & \rowfont{\scriptsize} /images/ & \rowfont{\scriptsize} Inserts a new image. \\
  \hline
  \rowfont{\scriptsize} DELETE & \rowfont{\scriptsize} /images/:name & \rowfont{\scriptsize} Deletes an existing image. \\ [1ex] 
  \hline
\end{tabular}
\end{center}
...
\begin{center}
 ...
 \hline
  \rowfont{\scriptsize} \textbf{Método} & \rowfont{\scriptsize} \textbf{Solicitud} & \rowfont{\scriptsize} \textbf{Descripción} \\ [0.5ex] 
  \hline\hline
  \rowfont{\scriptsize} POST & \rowfont{\scriptsize} /install\_packages/ & \rowfont{\scriptsize} Install one or more packages. \\ 
  \hline
  \rowfont{\scriptsize} POST & \rowfont{\scriptsize} /upgrade\_packages/ & \rowfont{\scriptsize} Upgrade one or more packages. \\
  \hline
  \rowfont{\scriptsize} POST & \rowfont{\scriptsize} /remove\_packages/ & \rowfont{\scriptsize} Remove one or more packages. \\ [1ex] 
  \hline
\end{tabular}
\end{center}
...
\captionof{table}{Métodos HTTP para files}
 ...
 \hline
  \rowfont{\scriptsize} \textbf{Método} & \rowfont{\scriptsize} \textbf{Solicitud} & \rowfont{\scriptsize} \textbf{Descripción} \\ [0.5ex] 
  \hline\hline
  \rowfont{\scriptsize} GET & \rowfont{\scriptsize} /files/:id & \rowfont{\scriptsize} Gets one file by ID. \\
  \hline
  \rowfont{\scriptsize} POST & \rowfont{\scriptsize} /files/ & \rowfont{\scriptsize} Upload a new file. \\
  \hline
  \rowfont{\scriptsize} DELETE & \rowfont{\scriptsize} /files/:id & \rowfont{\scriptsize} Deletes an existing file. \\
  \hline  
  \rowfont{\scriptsize} PUT & \rowfont{\scriptsize} /files/:id & \rowfont{\scriptsize} Updates an existing file. \\ [1ex]  
  \hline
\end{tabular}
\end{center}
...
\bibitem{xen16} (2016, Ago.) Xen Project. [Online]. Available: \url{https://www.xenproject.org/}.

\bibitem{kvm16} (2016, Ago.) Kernel-based Virtual Machine. [Online]. Available: \url{http://www.linux-kvm.org/page/Main_Page}.

\bibitem{vmware16} (2016, Ago.) VMware vSphere Hypervisor. [Online]. Available: \url{https://www.vmware.com/products/vsphere-hypervisor.html}.

\bibitem{virtualbox16} (2016, Ago.) Oracle Virtualbox. [Online]. Available: \url{https://www.virtualbox.org/}.

\bibitem{socc15} (2015, Jul.) ACM Symposium on Cloud Computing 2015. [Online]. Available: \url{http://acmsocc.github.io/2015}.

\bibitem{tanembaum14} Andrew S. Tanembaum, Modern Operating Systems, Amsterdam, The Netherlands: Pearson, 2014.

\bibitem{fabfile16} (2016, Ago.) Fabric. [Online]. Available: \url{http://www.fabfile.org/}.

\bibitem{juju16} (2016, Ago.) Ubuntu Juju. [Online]. Available: \url{http://www.ubuntu.com/cloud/juju}.

\bibitem{doccom16} (2016, Jul.) Docker Composer. [Online]. Available: \url{https://docs.docker.com/compose, 2016}.

\bibitem{Smart09} (2009, Jun.) SmartFrog. [Online]. Available: \url{http://smartfrog.org/display/sf/SmartFrog+Home}.

\bibitem{ans16} (2016, Jun) Ansible. [Online]. Available: \url{https://www.ansible.com}.

\bibitem{Amazon16} (2016, Jul.) Amazon EC2. [Online]. Available: \url{https://aws.amazon.com/ec2}.

\bibitem{Chef15} (2015, Oct.) Chef. [Online]. Available: \url{https://docs.chef.io, 2015}.

\bibitem{Pupet15} (2015, Dec.) Puppet. [Online]. Available: \url{http://projects.puppetlabs.com/projects/puppet}.

\bibitem{cfengine15} (2001, Sept.) Cfengine. [Online]. Available: \url{https://www.gnu.org/software/cfengine}.

\bibitem{bcfg215} (2015, Jan) Bdfg2. [Online]. Available: \url{http://bcfg2.org}.

\bibitem{Cobbler15} (2016, Feb.) Cobbler. [Online]. Available: \url{https://cobbler.github.io}.

\bibitem{smart16} (2009, Jan.) SmartFrog, [Online]. Available: \url{http://smartfrog.org/display/sf/SmartFrog+Home}.

\bibitem{Vag15} (2016, Mar.) Vagrant. [Online]. Available: \url{https://www.vagrantup.com}.

\bibitem{Salt15} (2016, Jan.) SaltStack. [Online]. Available: \url{http://saltstack.com/community}.

\bibitem{fielding00} (2000, Jun.) Architectural Styles and
...
\bibitem{fowler04} (2004, Jan.) Inversion of Control Containers and the Dependency Injection pattern. [Online]. Available: \url{http://martinfowler.com/articles/injection.html}.

\bibitem{rfc2104} (1997, Feb.) HMAC: Keyed-Hashing for Message Authentication. [Online]. Available: \url{https://www.ietf.org/rfc/rfc2104.txt}.

\bibitem{lxc16} (2016, Jun.) Linux Containers. [Online]. Available: \url{https://linuxcontainers.org}.

\bibitem{lxcubuntu16} (2016, Jun.) LXC Templates Documentation. [Online]. Available: \url{https://help.ubuntu.com/lts/serverguide/lxc.html}.

\bibitem{docker16} (2016, Jul.) Docker. [Online]. Available: \url{https://docker.com}.

\bibitem{Xinyang09} (2009, Dec) REST - An Alternative to RPC for Web Services Architecture. [Online]. Available: \url{http://web.uvic.ca/\~erikj/seng422/resources/rest\_paper.pdf}.
